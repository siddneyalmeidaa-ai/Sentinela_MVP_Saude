...
st.markdown("""
    ...
    .header-box { display: flex; justify-content: space-between; align-items: center; padding: 5px 10px; color: #00d4ff; font-weight: bold; font-size: 1.0rem; }
    .pro-tag { background-color: #00d4ff; color: #0e1117; font-size: 0.7rem; padding: 2px 6px; border-radius: 4px; font-weight: 900; }
    .metric-row { display: flex; justify-content: space-between; background: #1c2e4a; border-radius: 8px; padding: 8px 5px; margin: 5px 0px; }
    ...
    .status-box { padding: 10px; border-radius: 5px; margin-top: 5px; font-weight: bold; font-size: 0.85rem; text-align: center; }
    ...
    <div class="header-box"><span>🏛️ CONTROLE: IA-SENTINELA</span><span class="pro-tag">PRO</span></div>
...
# --- 🍕 GRÁFICO CORRIGIDO (PERCENTUAL NO LUGAR CERTO) ---
df_p = pd.DataFrame({
